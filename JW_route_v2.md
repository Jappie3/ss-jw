...
- Jump back up and continue right (we pick up the Mossberry later)
...
- Beat Skarrgard and enter Hunter’s March <!-- SPLIT: EnterHuntersMarch -->
...
- Head down the elevator (don't open the door since we won't use it)
...
- Head further down and grab Flea #22 <!-- SPLIT: -SavedFleaShellwood -->
- Go back up and right, and pick up Mask Shard #7 <!-- SPLIT: -MaskShard -->
- SQ
...
- Equip Silkspeed Anklets and turn in "Flexile Spines" getting Drifter’s Cloak
  <!-- SPLIT: DriftersCloak -->
- Do Fourth Chorus Quick Kill <!-- SPLIT: FourthChorus -->
...
- Head left and drop down to Bonegrave, grabbing Mossberry #2 in the room
- Enter Chapel of the Wanderer for Crest of the Wanderer
  <!-- SPLIT: WandererCrest -->
- Run to Bone Bottom and claim "Garb of the Pilgrims", "Volatile Flintbeetles"
  and "Terrible Tyrant" from the Bone Bottom quest board
...
- Head left and ring the bell <!-- SPLIT: -GreymoorBell -->
- Keep going left, drop down for a Bone Scroll
- Go back up, and kill the 3 pilgrims to the left for their cloaks, make sure to
  NOT turn in Crawbug Clearing yet
- Bellway to Shellwood
...
- Buy the Blasted Steps Bellway and the bench
  <!-- SPLIT: BlastedStepsStation -->
- Pick up Craftmetal #2 in the room before Last Judge
- Beat Last Judge and enter Act 2
...
- Do the Grand Gate platforming for Spool #11 and enter the shortcut
  <!-- SPLIT: -SpoolFragment -->
- Go straight right for the Lace interaction and bench in the room above the
  encounter
- Head all the way left towards Cogwork Heart piece #1
- Go back down, rescue Flea #9 <!-- SPLIT: -SavedFleaChoralChambersCage -->
- Go further left, drop down for the heavy rosary necklace in the shaft, head
  towards the Slab
- Head up, grab Spool #14 <!-- SPLIT: -SpoolFragment -->
- Go back down and unlock the Slab Bellway <!-- SPLIT: SlabStation -->
- SQ
- Head right immediately, drop down and go towards the Grand Bellway
- Buy the Bellway and Ventrica
- Go back up, and head all the way to First Shrine
- Open Ventrica, drop back down to pick up the key, make sure NOT to hit the
  bell <!-- SPLIT: CollectedWhitewardKey -->
- SQ
- Drop down and head into Whiteward
- Go through the intended route, picking up the Choral Commandment, opening up
  the shortcut and enter the Underworks

### Underworks

- Bench at architect
- Go left, down some more and back left for Flea #12
  <!-- SPLIT: -SavedFleaUnderworksCauldron -->
- Head back right, and up, go down long hallway on the left for Craftmetal #3
- Head to Clawline <!-- SPLIT: Clawline -->
- Purchase Sawtooth Circlet from the Architect
- Head right, drop down and pick up Spool #4 <!-- SPLIT: -SpoolFragment -->
- SQ
- Go left, down, and open the Underworks Ventrica
- Head down and left for Spool #5, make sure to open the gateway to the left
  <!-- SPLIT: -SpoolFragment -->
- Go back right, up, and take the ventrica to Grand Bellway
- Bellway to the Slab

### Mount Fay <!-- SPLIT: EnterMountFay -->

- Do Cocoon Skip when ascending Mount Fay and get Faydown Cloak at the top
- Drop down halfway, go left and up to pick up Flea #17 halfway up behind some
  ice <!-- SPLIT: -SavedFleaMountFay -->
...
- Ventrica to Songclave and enter Memorium, bench <!-- SPLIT: -EnterMemorium -->
- Enter up and right for Cogwork Heart piece #2
...
- SQ
- Drop down and head towards the Cogwork Dancers

### Choral Chambers

- Beat Cogwork Dancers with Circlet <!-- SPLIT: CogworkDancers -->
...
- Go farther down and talk to Loyal Mergwin and start "Great Taste of Pharloom"
- Run back left, down, and open the shortcut in the room left of Mergwin
- Head up towards High Halls, grabbing Flea #10 and the rosary chest along the
  way <!-- SPLIT: -SavedFleaChoralChambersWind -->
- In High Halls, get Spool #12 at the top of the first tall room
  <!-- SPLIT: EnterHighHalls --> <!-- SPLIT: -SpoolFragment -->
...
- Head further up towards the Architects Melody
- Learn the Architects Melody <!-- SPLIT: ArchitectsMelody -->
- Drop back down, and enter Whispering Vaults on the right
  <!-- SPLIT: EnterWhisperingVaults -->

### Whispering Vaults

- Drop all the way down, and head left
- Use wings to pick up Flea #11 <!-- SPLIT: -SavedFleaWhisperingVaults -->
- Grab Pale Oil to the left, and head back right
- Loop around, and grab Cogwork Heart piece #3
- Go up, open the shortcut, and enter Grand Bellway through the stage
- Bellway to Bellhart for needle upgrade <!-- SPLIT: -NeedleUpgrade2 -->
- Accept "My Missing Brother" quest
- Sell all relics
- Bellway to the Blasted Steps

## Part 3: Left Side Area Clearing

### Blasted Steps

- Bench, head down and left to beat the Great Conchflies
...
- Head right, and grab Flea #19 using the pogo on the plant seed
  <!-- SPLIT: -SavedFleaSandsOfKarak -->
- Go all the way right for a Simple key, do NOT bench here
...
- Head right of Craggler and jump the gap, opening the Bone Bottom elevator on
  the way
- Go grab the rosaries & Spool #1 to the right, head back
  <!-- SPLIT: -SpoolFragment -->
- Grab Mossberry #3 when dropping down to Bone Bottom, and bench
- Drop down towards Atla, and pick up Mossberry #4 that we missed earlier
- Enter Weavenest Atla <!-- SPLIT: EnterWeavenestAtla -->
...
- Head right to the Moss Druid and collect 3 garbs and Mossberry #6 under the
  druid along the way
- Get the Mossberry Stew from the Moss Druid
- Turn in "Berry Picking" for Druid’s Eye
- Turn in the remaining 3 Mossberries for the rosaries
...
- Head down and right for Flintbeetle #3, and collect 2 more garbs along this
  path
- Bench in Loodle’s hut, and head down and left
- Defeat Skull Tyrant 1 <!-- SPLIT: -SkullTyrant1 -->
- SQ
...
- Head up for Fractured Mask and Curveclaw / Rosaries (break them slowly)
...
- Drop down and bellway to Grand Bellway

## Part 4: The Mist + Cursed

### Whispering Vaults:

- Head up to the Stage, and beat Trobbio for the Claw Mirror
  <!-- SPLIT: Trobbio -->
- Go through Underworks like normal
- Pick up Sacred Cylinder
- Go right, push up the box to grab Mask Shard #3 <!-- SPLIT: -MaskShard -->
- Head right into the secret path, head further up and grab Memory Locket #?
- Go back and after the parkour, head up and grab Flea #13
  <!-- SPLIT: -SavedFleaSongclave -->
- Clawline to the left and grab the Heavy Rosary Necklace
- Drop down, open the shortcut, grab the Psalm Cylinder and head to First Shrine
- Ring the bell, and drop back into Whispering Vaults
  <!-- SPLIT: SongclaveBell -->
- SQ
- Donate "Building up Songclave", and claim "The Lost Mechant" from the quest
  board
- Head back into Whispering Vaults, and go straight to Cardinius.
- Pick up the Psalm Cylinder in the room, and after selling all the cylinders,
  learn Vaultkeepers Melody <!-- SPLIT: -VaultkeepersMelody -->
- Head back through the hidden passage, and drop down to Bilewater
  <!-- SPLIT: -EnterBilewater -->

### Bilewater

- Break the first wall on the left for Twisted Bud
- Grab the rosary rocks in the next room
- Continue progressing, and buy the bellway <!-- SPLIT: -BilewaterStation -->
...
- SQ
- Free Kratt to the right (Flea #23) <!-- SPLIT: -SavedFleaKratt -->
- Enter Sinner’s Road
...
- Drop down and go right for Mask Shard #8 <!-- SPLIT: -MaskShard -->
- SQ
...
- Claim Crawbug Clearing and buy the Nectar from Criege, drop down and beat the
  Skarrs
- SQ
- Enter Chapel of the Reaper for Reaper Crest <!-- SPLIT: ReaperCrest -->
...
- Continue right for Mask Shard #9 <!-- SPLIT: -MaskShard -->
- SQ

## Part 5: Songclave Quests

### Bellhart:

- Sell all your relics, donate "Restoration of Bellhart", claim "Savage
  Beastfly", "Trails End" and start "My Courier’s Rasher"
- During the courier quest, go through Wisp Thicket
- On the way, grab Craftmetal #4 and Flea #25
  <!-- SPLIT: -SavedFleaUnderworksWispThicket -->
- Continue through Underworks, and hit the lever for Delver’s Drill later
- Head right, and rescue Jubilana, grab the rosary neclace in the same room
  <!-- SPLIT: -JubilanaRescuedChoralChambers -->
- Go further up and get the Pale Oil from Loyal Mergwin
- Enter cogwork core from where the mask shard was, activate Second Sentinel
  <!-- SPLIT: SecondSentinelAwoken -->
- SQ
- Donate "Bellhart’s Glory" and get the needle upgrade from Plinney
  <!-- SPLIT: -NeedleUpgrade3 -->
- Bellway to the Grand Bellway

### Choral Chambers

- Bench, head left to see Sentinel fight #1
- SQ
- Ventrica to High Halls
...
- Run left to Cogwork dancer arena, see Sentinel fight #2
- Beat Lace 2 for Silk Heart #2 <!-- SPLIT: Lace2 -->
- Ventrica to Songclave, bench, accept "Balm for the Wounded" and "Final
  Audience"
- Ventrica to High Halls, fight Second Sentinel and grab the Reserve Bind
  <!-- SPLIT: SecondSentinel -->
- Drop all the way down to Whiteward
...
- Jump up to get the Surgeon Key <!-- SPLIT: CollectedSurgeonsKey -->
- SQ
- Donate "Strengthening Songclave", and drop down into Whispering Vaults
- SQ
- Accept "Lost Merchant"
...
- Pick up Seeker Soul, and head back down
...
- Call Bell Beast back, head into the hidden pathway right of the bellway
- Get Mask Shard #1 down and to the left <!-- SPLIT: -MaskShard -->
- Go back up and free Flea #7 <!-- SPLIT: -SavedFleaFarFieldsPilgrimsRest -->
- SQ
...
- Drop down for Spool #13 <!-- SPLIT: -SpoolFragment -->
...
- Get the Bellhome key from Pavo, and turn in "Savage Beastfly" for Mask Shard
  #16 <!-- SPLIT: -MaskShard -->
- Head right towards the fleas
- Travel with the fleas all the way to Fleatopia, picking up Spool #10, Tool
  <!-- SPLIT: -SpoolFragment --> Pouch, and Egg of Flealia along the way
- Head left towards Huntress, and claim the Longclaw
- Head up, and bellway to Bone Bottom
- Turn in "Garb of the Pilgrims", "Volatile Flintbeetles", and "Terrible Tyrant"
  (Memory Locket #10 reward)
- Donate for "A Lifesaving Bridge"
- Buy Mask Shard #11 and Craftmetal #7 from Pebb <!-- SPLIT: -MaskShard -->
- Bench, bellway to Grand Bellway
- Ventrica to Songclave to pick up "Silk and Soul"
  <!-- SPLIT: SilkAndSoulOffered -->
- SQ
...
- Rush to Grand Bellway through the Stage to beat Bell Eater for Beastling Call
  <!-- SPLIT: EnterBellEater --> <!-- SPLIT: BeastlingCall -->
...
- Buy Cogwork Wheel, Scuttlebrace, and a Crafting Kit from the Architect
  <!-- SPLIT: CraftingKit2 -->
- Get the Architect’s Key and Architect Crest <!-- SPLIT: ArchitectCrest -->
- Bellway to the Putrified Ducts
- Head to Fleatopia and become the Flea Olympics Champion for Pale Oil
  <!-- SPLIT: -FleaFestivalBegin --> <!-- SPLIT: FleaFestivalEnd -->
- Beastling call out, bellway to Bone Bottom and talk to the Shamans
- Bellway to Deep Docks and buy everything from Forge Daughter: Sting Shard,
  Magma Bell, Crafting Kit <!-- SPLIT: CraftingKit3 -->
- Speak to Ballow <!-- SPLIT: BallowMoved -->
- Head down a bit in Deep Docks for Spool #16 <!-- SPLIT: -SpoolFragment -->
- Drop down before abyss for Memory Locket #11
- Enter the Abyss <!-- SPLIT: EnterAbyss -->

### Abyss

- Progress to the end normally and get Silk Soar <!-- SPLIT: -SilkSoar -->
- While going back up, get the Arcane Egg using Silk Soar skip
- Escape the Abyss, Beastling Call out <!-- SPLIT: AbyssEscape -->

### Deep Docks

- Run left to the Marrow, picking up Mask Shard #13 in the room that connects
  the areas <!-- SPLIT: -MaskShard -->
- Break Void Mass #4
- Enter Loodle’s hut for the Straight Pin and a Tool Pouch
- Beastling Call out
- Bellway to Bellhart and bench
- Accept "Dark Hearts" and "Fatal Resolve"
- Use Silk Soar to grab the Memory Locket #12 above Bellhart
- Bellway to Shellwood, and rescue Plinney
- SQ
- Buy the final needle upgrade from Plinney <!-- SPLIT: -NeedleUpgrade4 -->
...
- Pop all remaining memory lockets (on non-hunter crests), drop down to
  Weavenest Atla and get Sylphsong from Eva <!-- SPLIT: Sylphsong -->
- Bellway to Grand Bellway

### Choral Chambers

- Ventrica to Songclave, navigate back to Grand Mother Silk
- Silk Soar for Pale Nails <!-- SPLIT: -PaleNails -->
...
- Drop down through the Surgeon’s Key Entrance to beat the Unraveled for Silk
  Heart #3 <!-- SPLIT: TheUnravelled -->
- Go further down, and Beastling Call, bellway to Far Fields
...
- Head further right and all the way through east Far Fields to beat
  Sprintmaster Swift for Mask Shard #15 <!-- SPLIT: -MaskShard -->
- Head up to Karmelita, breaking Void Mass #1 on the way
- Beat Karmelita <!-- SPLIT: -EnterKarmelitaMemory -->
  <!-- SPLIT: SkarrsingerKarmelita -->
- Beastling Call out, bellway to Bellhart and accept "Hidden Hunter"
- SQ
- Beat Gurr and pick up the Grass Doll <!-- SPLIT: GurrTheOutcast -->
- Beastling Call and Bellway to Blasted Steps

### Blasted Steps

- Bench, drop down to Pinstress’ home, break Void Mass #12
- Begin Pinstress’ ascent to Mount Fay
- SQ
- Head right towards Grand Gate, and destroy Void Mass #? along the way
- Drop the elevator, and head right
- Pick up Delver’s Drill
- SQ
- Go left through the wall in the elevator drop for Void Mass #10
- Beat Seth and Nyleth <!-- SPLIT: Seth --> <!-- SPLIT: -EnterNylethMemory -->
  <!-- SPLIT: Nyleth -->
- Beastling Call out, and head left
- Buy everything needed from Grindle: Spool #18, Tool Pouch, Crafting Kit,
  Snitch Pick <!-- SPLIT: -SpoolFragment -->
- Enter Karak from above Grindle
- Navigate to Coral Tower, beating Great Conchfly on the way
  <!-- SPLIT: RagingConchfly -->
- Get Conchcutter from Coral Tower
- Beat Coral Tower and Crust King Khann <!-- SPLIT: EnterKhannMemory -->
  <!-- SPLIT: CrustKingKhann -->
- Beastling Call out and Bellway to The Slab
...
- Beat First Sinner and learn Rune Rage, Beastling Call out
  <!-- SPLIT: FirstSinner --> <!-- SPLIT: RuneRage -->
...
- Turn in "Dark Hearts" and "Hidden Hunter" for Mask Shard #19 and Mask Shard
  #20 <!-- SPLIT: -MaskShard --> <!-- SPLIT: -MaskShard -->
- Buy Spool #17 and Multibinder from Frey <!-- SPLIT: -SpoolFragment -->
